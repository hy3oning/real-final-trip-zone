...
export function getMapCenter(rows) {
  return [
...
export function LodgingMapPanel({ filteredLodgings, activeLodgingId, focusLodging, mapInstance, setMapInstance }) {
  if (!filteredLodgings.length) return null;
